        ...
        <>
            ...
            <main>
                <div className='main-div' style={inter.style}>
                    ...
                    <TypeAnimation
                        id='typing-text'
                        sequence={['We provide housing info!', 1000, 'We can blah blah blah', 1000]}
                        repeat={Infinity}
                        wrapper="span"
                        speed={50}
                    />
                    <Searchbox towns={formattedTowns} amenities={amenities} flat_types={flat_types} price_range={price_range}/>
                </div>
            </main>
        </>
    )
